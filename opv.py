...
class OpvModel(OpvExec):
    def __init__(self, model_name, device, fp="FP32", debug=False, ncs=1):
        ...
        #model_xml = "/opt/intel/openvino/deployment_tools/intel_models/"+model_name+"/"+fp+"/"+model_name+".xml"
        ...
        plugin.add_cpu_extension("/opt/intel/computer_vision_sdk/deployment_tools/inference_engine/lib/ubuntu_18.04/intel64/libcpu_extension_avx2.so")
